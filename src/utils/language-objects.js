...
export const ua = {
    ...
    project3Content: {
      ...
      learned: {
        ...
        list: [
          ...
          'Використання Redux Toolkit для запитів та керування даними;',
  ...
  footer: {
    quotes: [
      ...
      'Завжди кодуйте так, ніби людиа, яка зрештою буде підтримувати ваш код - жорстокий психопат, який знає, де ви живете.',
